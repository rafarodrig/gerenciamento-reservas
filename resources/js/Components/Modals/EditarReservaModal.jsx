...
import { ArrowLeft, Clock1, LucideUserRoundPen, PenSquare } from 'lucide-react';
    ...
    <>
      ...
      >
        ...
        <Modal.Footer className='modal-footer '>
          <CancelarButton onClick={onClose} > <ArrowLeft size={20} />  Voltar</CancelarButton>
        </Modal.Footer>
      </Modal>
    </>
  );
