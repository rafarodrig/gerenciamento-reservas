...
export default function EditarReservaModal({ showModal1, reserva, setShow, handleCloseModal1 }) {
  ...
  const handleSubmitEditar = (e) => {
    e.preventDefault();
    // Lógica de envio
    setShow(); // provavelmente abre modal de confirmação
    handleCloseModal1();
  };

  return (
    <Modal show={showModal1} onHide={handleCloseModal1} centered size="lg">
      ...
      <Modal.Body>
          ...
          <Col md={6}>
            <Card className="shadow-sm h-100">
              <Card.Body>
                ...
                <p className="mb-1"><strong>Número:</strong> {reserva.sala.numero} - {reserva.sala.tipo}</p>
                <p className="mb-1"><strong>Unidade:</strong> {reserva.sala.unidade}</p>
                <p className="mb-1"><People className="me-1" /> {reserva.sala.lotacao} pessoas</p>
          ...
          <Col md={6}>
            <Card className="shadow-sm h-100">
              <Card.Body>
                ...
                <p className="mb-1"><strong>Data:</strong> {converterData(reserva.data)}</p>
                <p className="mb-1"><strong>Turno:</strong> {reserva.turma.turno}</p>
        ...
        <Form onSubmit={handleSubmitEditar} id="form-editar-reserva">
            ...
            <Col md={6}>
              <Form.Group className="form-floating">
                <Form.Select
                  ...
                  required
                >
                  <option value={reserva.sala.id}>
                    {reserva.sala.numero} - Unidade {reserva.sala.unidade}
                  </option>
                  <OptionsSalas id={reserva.id} show={showModal1} />
                </Form.Select>
            ...
            <Col md={6}>
              <Form.Group className="form-floating">
                ...
                >
                  ...
                  <OptionsTurmas id={reserva.id} show={showModal1} />
                </Form.Select>
      ...
      <Modal.Footer>
        ...
        <Button variant="primary" type="submit" form="form-editar-reserva">
